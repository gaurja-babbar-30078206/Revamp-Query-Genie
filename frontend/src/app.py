...
def login_page():
    ...
    # st.title('Some content')
        ...
        st.error('Username/password is incorrect')  # or Microsoft login failed
    elif st.session_state['authentication_status'] is None:
        st.warning('Please enter your username and password') # or login with Microsoft
...
# --- Multi-Page Setup ---
app = MultiPage()  # Create a MultiPage object
app.add_app("Login", login_page) # Add the login page
app.add_app("Main App", main_app) # Add the main app page


# --- Run the App ---
if __name__ == "__main__":
    if st.session_state.get("authentication_status", None) is True:  # Check login status
        # app.run(page="Main App") # Show main app if logged in
        main_app()
    else:
        # app.run(page="Login")
